...
public class GenericCrudListener<T extends CrudService<G>, G> implements CrudListener<G> {

    private final Logger logger = LoggerFactory.getLogger(GenericCrudListener.class);

    private final T service;
    private final GridCrud<G> crud;

    public GenericCrudListener(T service, GridCrud<G> crud) {
